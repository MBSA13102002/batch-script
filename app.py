...
def start():
    if request.method == 'POST':
        age = float(request.body.get("age"))
        gender = float(request.body.get("gender"))
        weight_kg = float(request.body.get("weight_kg"))
        height_cm = float(request.body.get("height_cm"))
